...
CUSTOM_HAL_CAM_CAL = s5k3m2_eeprom dummy_eeprom
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = imx214_mipi_raw s5k3m2_mipi_raw ov13850_mipi_raw ov5648_mipi_raw
CUSTOM_HAL_LENS = dw9714af fm50af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = imx214_mipi_raw s5k3m2_mipi_raw ov13850_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = s5k3m2_eeprom dummy_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = imx214_mipi_raw s5k3m2_mipi_raw ov13850_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx214_mipi_raw s5k3m2_mipi_raw ov13850_mipi_raw
...
CUSTOM_MODEM = t925_hct6753_65c_l1-lwg_dsds-_fdd3m137820
...
MTK_BT_SUPPORT = yes
CUSTOM_BUILD_VERNO = R17
MTK_BUILD_VERNO =DOOGEE-F3_Pro-Android_5.1-R17-2015.10.21
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
#CREATE_PROJECT_INFO=2015050515584
#adupsfota start
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=no
ADUPS_FOTA_WITHOUT_MENU=no
#adupsfota end
####################### HCT Drv Config ----------  begin ########################

#################################################################################
HCT_LOCALIZATION_OVERLAY = zh-rCN
HCT_BUILD_PRODUCT_NAME =  t925t-dg-a36-33gu-fhd-128g24g-fdd_53-iis-5p
HCT_PROJECT = T925_PROJ
HCT_SUB_PROJECT =
HCT_SUB_SUB_PROJECT =

HCT_USING_EXTAMP_HP=yes
HCT_BMC056_SUPPORT=no
MTK_NCP1854_SUPPORT=yes

HCT_PRODUCT_BRAND = F3_Pro 
HCT_PRODUCT_MODEL = F3_Pro 
HCT_PRODUCT_MANUFACTURER = F3_Pro 
HCT_BOOTANIM = yes
#HCT_BOOTAUDIO = yes
#HCT_SHUTANIM = yes
#HCT_SHUTAUDIO = yes
GANGYUN_CAMERA_BEAUTY = yes
HCT_DG_PREINSTALL_APKS = yes
HCT_GOOGLE_GMS_R2 = yes
HCT_SUPPORT_POWER_SAVE_PLUS = yes
GANGYUN_CAMERA_MAKEUP_OVERSEA  = yes
HCT_LETTICE_VOICE_WAKUP_SUPPORT = yes
####################### HCT Drv Config --------------end ########################
HCT_PRODUCT_TIMEZONE = Europe/London
HCT_RESTORE_CUSTOMER_RESOURCE = yes
HCT_MULTI_FINGER_GESTURE_SUPPORT = yes
THEME_RES_NORMAL = yes
HCT_SUPPORT_APPLOCK=yes
HCT_GESTURE_SUPPORT_DOOGEE=yes
HCT_EXTRA_RINGTONE_SHOW_MORE_RINGTONES = yes
HCT_RINGTONE = Callisto.ogg
HCT_NOTIFICATION_SOUND = bamboo.ogg
HCT_ALARM_ALERT = Helium.ogg
HCT_SUPPORT_SIMPLE_CLOCK = yes
#HCT_SETTINGS_SUPPORT = yes
HCT_TP_GUESTURE_SUPPORT=yes
HCT_GALLERY_SUPPORT = yes
HCT_TORCH_SUPPORT = yes
HCT_RESTORE_CUSTOMER_RESOURCE = yes
HCT_SHORTEN_FIRT_BOOT_TIME = yes
HCT_PACKAGES_SUBSTITUTE = AndroidForWork:- CalendarGoogle:- CloudPrint:- DeskClockGoogle:- EditorsDocs:- EditorsSheets:- EditorsSlides:- FaceLock:- GoogleCamera:- GoogleHome:- GoogleTTS:- Keep:- LatinImeGoogle:- NewsWeather:- TagGoogle:- talkback:- DMAgent:- GoogleEars:- GoogleEarth:- GoogleHindiIME:- GooglePinyinIME:- KoreanIME:- Wallet:- google_generic_update.txt:- com.google.android.maps.jar:- Music2:- JapaneseIME:- Bugle:- com.google.android.media.effects.jar:- Chrome:- Hangouts:- Drive:- PlusOne:- Books:- Newsstand:- PlayGames:- YouTube:- Videos:- Photos:-
